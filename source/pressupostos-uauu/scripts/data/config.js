...
export const PDF_TEXT = {
  ca: {
    ...
    venueLabel: 'Finca',
    formatLabel: 'Format',
    formatNames: { finca: 'Finca', coctel: 'Còctel' },
    ...
    pdfMinDetail: (short, pen, min) => `${short} pers. × ${eur(pen)} (per sota del mínim ${min})`,
  ...
  es: {
    ...
    venueLabel: 'Finca',
    formatLabel: 'Formato',
    formatNames: { finca: 'Finca', coctel: 'Cóctel' },
    ...
    pdfMinDetail: (short, pen, min) => `${short} pers. × ${eur(pen)} (por debajo del mínimo ${min})`,
  ...
  en: {
    ...
    venueLabel: 'Venue',
    formatLabel: 'Format',
    formatNames: { finca: 'Venue', coctel: 'Cocktail' },
    guestsLabel: 'Guests',
    ...
    pdfMinDetail: (short, pen, min) => `${short} pers. × ${eur(pen)} (below the minimum ${min})`,
